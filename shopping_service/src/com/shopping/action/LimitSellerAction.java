...
public class LimitSellerAction {
	...
	private List<Seller> limitlist=new ArrayList<Seller>();
	private JSONArray limitjson=new JSONArray();
	
	public String getLimitData() throws Exception {
        String sql;
